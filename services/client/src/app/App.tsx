        ...
        >
          ...
          <View style={styles.section}>
            <View style={[styles.shadowBox]}>
              ...
              <TouchableOpacity
                style={[styles.listItem, styles.learning]}
                onPress={() => Linking.openURL('https://nx.dev/recipes/react/react-native#react-native-with-nx')}
              >
                <Svg width={24} height={24} stroke="#000000" fill="none" viewBox="0 0 24 24">
                  <Path
                    strokeLinecap="round"
          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                <Text style={[styles.textXS, styles.monospace, styles.marginBottomMd]}>nx build Client</Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}># Test</Text>
                <Text style={[styles.textXS, styles.monospace, styles.marginBottomMd]}>nx test Client</Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}># Lint</Text>
                <Text style={[styles.textXS, styles.monospace]}>nx lint Client</Text>
                ...
                <Text style={[styles.textXS, styles.monospace, styles.marginBottomMd]}>
                  nx run-many -p Client -t build test lint
                </Text>
              </View>
              ...
              <View style={[styles.codeBlock, styles.marginBottomLg]}>
                <Text style={[styles.textXS, styles.monospace]}>nx show project Client</Text>
              </View>
              <View style={styles.listItem}>
                <Svg width={24} height={24} stroke="#000000" fill="none" viewBox="0 0 24 24">
                  <Path
